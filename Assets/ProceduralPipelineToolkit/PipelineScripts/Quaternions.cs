...
namespace PipelineToolkit {
	...
	public static class Quaternions {
		...
		public static Quaternion GetQuatSquad(double t, Quaternion q0, Quaternion q1, Quaternion a0, Quaternion a1) {
		...
		public static Quaternion QuatSlerp(Quaternion p, Quaternion q, float t) {
			Quaternion ret;
